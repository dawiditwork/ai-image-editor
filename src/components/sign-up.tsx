...
const { mutate: signUpEmail, isPending: signUpPending } = useSignUpEmail({
  ...
  return (
   <Card
    className={cn(
      "w-full max-w-lg rounded-3xl border border-slate-200 bg-white shadow-2xl",
      className
    )}
  >
    <CardHeader className="px-8 pt-8 pb-2">
      ...
      <p className="text-slate-500 mt-2">
        Create your free account and start editing images with AI.
      </p>
    </CardHeader>
                ...
                {usernameConfig?.enabled && (
                  ...
                  >
                    ...
                    <InputGroup>
                      ...
                      <FieldError>
                        {(() => {
                          const message = getErrorMessage(usernameError);
                          ...
                          if (usernameData?.available === false) {
                            return localization.auth.usernameTaken;
                          }
  ...
  type="submit"
  disabled={isPending}
  className="h-12 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white hover:from-blue-700 hover:to-purple-700"
>
                    {isPending && <Spinner />}
