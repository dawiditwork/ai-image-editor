...
import { env } from "~/env";
import DashboardPaymentRedirect from "./DashboardPaymentRedirect";
  ...
  useEffect(() => {
    const initializeDashboard = async () => {
      try {
        ...
        const projects: Project[] = projectsResult.projects.map((p) => ({
        ...p,
            ...
            <CardContent>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <Button
                  ...
                  className="group h-auto flex-col gap-2 bg-gradient-to-r from-violet-600 to-indigo-600 p-6 hover:from-violet-700 hover:to-indigo-700"                >
  ...
  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
    {[
      ...
      },
      {
        ...
        {
        name: "PDF Tools",
        description: "Export images or merge multiple images into PDF",
        icon: "📄",
  },
      {
        name: "Convert Format",
        description: "Convert PNG, JPG, WEBP and more",
        icon: "🔄",
      },
      ...
      >
        <div className="group hover:border-primary/40 hover:bg-muted/50 cursor-pointer rounded-xl border p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
